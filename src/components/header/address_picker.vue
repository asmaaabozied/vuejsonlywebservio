...
<!--                    this.setCurrentAddressAction(this.newAddress); toggleAddressPickerAction();-->
                    <button
...
export default {
  ...
  methods: {
    ...mapActions('user', ['toggleAddressPickerAction', 'setNewAddressAction', 'setCurrentAddressAction','addAddressAction']),
    updateFullAddress(e) {
    ...
    addaddress() {
      ...
      console.log("aaa",this.newAddress)

      this.addAddressAction(this.newAddress).then(result => {
