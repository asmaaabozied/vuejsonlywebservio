...
import address from '/src/views/address.vue'
import addaddress from '/src/views/addaddress.vue'
...
import RegisterProvider from '/src/views/RegisterProvider.vue'
...
const routes = [
    ...
    { path: '/registerProvider', name: 'RegisterProvider', component: RegisterProvider, meta: { requiresNotAuth: true } },
