<template>
  <Heading category='Results of search for' />
  <div class='bg-white'>
    <div
      ...
      <div class='lg:col-span-4'>
        ...
        <div v-if='eServicesOfCategory.length > 10' class='flex w-full py-12'>
          <button
...
export default {
  ...
  methods: {
    ...
    loadEServices() {
      this.getSearchEServicesAction({ keywords: this.$route.params.keywords })
    },
    loadMoreEService() {
      this.incrementPage()
      this.loadEServices()
